...
public class BeanLifeCycle {
    ...
    public BeanLifeCycle(Consumer<Object> valuesInjector, FieldsInjector fieldsInjector,
                         DoProxy doProxy, Set<BeanPostProcessor> processors) {
    ...
    public Object makeLifeCycle(Object origin, BeanDefinition definition) {
        ...
        var proxyInstance = doProxy.proxyBean(origin, definition);
